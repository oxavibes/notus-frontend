    ...
    <div class="flex content-center items-center justify-center h-full">
      <div class="w-full md:w-6/12 lg:w-4/12 px-4">
        ...
        >
          ...
          <div class="flex-auto px-4 lg:px-10 pt-0 pb-6">
            ...
            <form>
              ...
              <div
                class="flex flex-row-reverse flex-no-wrap mt-6 relative justify-around"
              >
                <div class="w-auto">
                  <NuxtLink to="/auth/forgotpassword">
                    <small class="text-sm capitalize font-bold"
