<template>
  <footer
    class="pb-6 bg-gray-900 bg-opacity-50"
    ...
    <div class="container mx-auto px-4">
      ...
      >
        <div class="w-full md:w-4/12 px-4">
          <div
            class="text-orange-500 text-sm font-bold py-1 text-center md:text-left"
          >
            Copyright © {{ date }}
            <a
              href="https://www.creative-tim.com?ref=vn-footer-small"
              class="text-white hover:text-gray-400 text-sm font-semibold py-1 ml-1"
            >
              Creative Tim
            </a>
          </div>
